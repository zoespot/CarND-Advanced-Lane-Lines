...
![alt text]('./writeup_images/camera_calibration.png')
...
![alt text]('./writeup_images/image_undist.png')
...
![alt text]('./writeup_images/threshold_binary.png')
...
![alt text]('./writeup_images/transform_points.png')
...
![alt text]('./writeup_images/draw_area.png')
...
![alt text]('./writeup_images/lab.jpg')

![alt text]('./writeup_images/threshold_binary_challenge.png')

![alt text]('./writeup_images/challenge_draw_area.png')
...
[link to my project video result](./output_videos/output_project_video.mp4).

[link to my challenge video result](./output_videos/output_challenge_video.mp4)
